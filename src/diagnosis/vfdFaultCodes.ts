...
const rawManufacturerFaultCodes: Array<Omit<ManufacturerFaultCode, 'descriptionTr'>> = [
  ...
  { manufacturer: 'Siemens', modelFamily: 'SINAMICS G120', code: 'F08501', title: 'Setpoint timeout', titleTr: 'Set değeri zaman aşımı', description: 'The expected setpoint signal was not received in time.', recommendedChecks: ['Referans kaynağı ve haberleşme bağlantısını yetkili personelle doğrulayın.', 'Kontrol modu ve setpoint zaman aşımı parametrelerini inceleyin.'], relatedParameters: [{ code: 'p2044', nameTr: 'Haberleşme izleme süresi', purposeTr: 'PROFINET set değeri / haberleşme zaman aşımı izleme süresini kontrol etmek için.' }], ...siemensSource },
